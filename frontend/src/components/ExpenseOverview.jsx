...
import { get7DayExpenseData, get30DayExpenseData, getYearlyExpenseData } from '../utils/expenseUtils'
...
const ExpenseOverview = ({ transactions }) => {
    ...
    const getData = () => {
        switch (range) {
            case '30d':
                return get30DayExpenseData(transactions)
            case 'year':
                return getYearlyExpenseData(transactions)
            default:
                return get7DayExpenseData(transactions)
        }
    }
