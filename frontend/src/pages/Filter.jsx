                    ...
                    <form className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-6 gap-4">
                        ...
                        <div className='sm:col-span-1 md:col-span-1 flex items-end'>
                            <div className="w-full">
                                ...
                                <input value={keyword} id='keyword' type='text' placeholder='Search Transactions' className='w-full border rounded px-3 py-2' onChange={(e) => setKeyword(e.target.value)}/>
                            </div>
                            <button onClick={handleSearch} className="ml-2 mb-1 p-2 bg-blue-500 hover:bg-blue-700 text-white rounded flex items-center justify-center cursor-pointer">
                                <Search size={20} />
                            </button>
                        </div>
                    </form>
